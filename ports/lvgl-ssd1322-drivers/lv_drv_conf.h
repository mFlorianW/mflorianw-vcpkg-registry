...
#define EVDEV_SCALE                                                            \
  0 /* Scale input, e.g. if touchscreen resolution does not match display      \
       resolution */
#if EVDEV_SCALE
...
#if EVDEV_CALIBRATE
#define EVDEV_HOR_MIN                                                          \
  3800 /*If EVDEV_XXX_MIN > EVDEV_XXX_MAX the XXX axis is automatically        \
          inverted*/
